...
const mockAvatarStyle: AvatarStyle = {
  top: { id: "1", name: "Top", category: "top", color: "#8B5CF6" },
  pants: { id: "2", name: "Pants", category: "pants", color: "#4F46E5" },
  shoes: { id: "3", name: "Shoes", category: "shoes", color: "#7C3AED" },
  hair: { id: "5", name: "Hair", category: "hair", color: "#F59E0B" },
  accessories: [
    { id: "4", name: "Hat", category: "accessories", color: "#EC4899" },
  ],
};
      ...
      <div className="p-6 flex flex-col items-center">
        ...
        <div className="text-center max-w-md text-gray-700 mb-6">
          ...
          <p className="mt-2 text-sm">
            Welcome to my corner of DormLit. Dreaming, building, vibing.
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-3 w-full max-w-sm mb-10">
          <a
            href="#"
            className="bg-purple-500 text-white py-2 rounded-lg text-center hover:bg-purple-600 transition"
          >
            My Portfolio
          </a>
          <a
            href="#"
            className="bg-blue-400 text-white py-2 rounded-lg text-center hover:bg-blue-500 transition"
          >
            My Socials
          </a>
          <a
            href="#"
            className="bg-green-400 text-white py-2 rounded-lg text-center hover:bg-green-500 transition"
          >
            Support Me
          </a>
        </div>
